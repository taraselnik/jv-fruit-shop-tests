...
class SupplyOperationTest {
    ...
    @BeforeEach
    void setUp() {
        supplyOperationHandler = new SupplyOperation();
    }
    ...
    void apply_validInputs_ok() {
        ...
        String expected = "20";
        String actual = supplyOperationHandler.apply(initialQuantity, quantity);
    ...
    void apply_nullInitialQuantity_notOk() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> supplyOperationHandler.apply(null, quantity));
    }
    ...
    void apply_nullQuantity_notOk() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> supplyOperationHandler.apply(initialQuantity, null));
    }
    ...
    void apply_negativeQuantity_notOk() {
        ...
        BigDecimal quantity = new BigDecimal("-5");
        assertThrows(IllegalArgumentException.class,
                () -> supplyOperationHandler.apply(initialQuantity, quantity));
    }
